...
wp_enqueue_style('owl-patch-library', $resUri . 'css/owlspa.css', array('screen'), '0.0.2'); // screen is the name of the theme style.css handle
wp_enqueue_script('owl-patch-library', $resUri . 'js/bundle.js', array(), '0.0.2', true);
