...
export const SET_PATCHLIST_SEARCH_TERM = 'SET_PATCHLIST_SEARCH_TERM';
...
export const FETCH_PATCH_SOURCE_FILE_REQUEST = 'FETCH_PATCH_SOURCE_FILE_REQUEST';
export const FETCH_PATCH_SOURCE_FILE_SUCCESS = 'FETCH_PATCH_SOURCE_FILE_SUCCESS';
export const FETCH_PATCH_SOURCE_FILE_ERROR = 'FETCH_PATCH_SOURCE_FILE_ERROR';
export const UPDATE_PATCH_SOURCE_FILE = 'UPDATE_PATCH_SOURCE_FILE';
export const SAVE_PATCH_SOURCE_FILES_REQUEST = 'SAVE_PATCH_SOURCE_FILES_REQUEST';
export const SAVE_PATCH_SOURCE_FILES_SUCCESS = 'SAVE_PATCH_SOURCE_FILES_SUCCESS';
export const SAVE_PATCH_SOURCE_FILES_ERROR = 'SAVE_PATCH_SOURCE_FILES_ERROR';
export const CLEAR_PATCH_SOURCE_CODE_FILES = 'CLEAR_PATCH_SOURCE_CODE_FILES';
...
export const STORE_PATCH_ON_DEVICE_REQUEST = 'STORE_PATCH_ON_DEVICE_REQUEST';
export const STORE_PATCH_ON_DEVICE_ERROR = 'STORE_PATCH_ON_DEVICE_ERROR';
export const STORE_PATCH_ON_DEVICE_SUCCESS = 'STORE_PATCH_ON_DEVICE_SUCCESS';
export const PROMPT_USER_FOR_STORE_SLOT = 'PROMPT_USER_FOR_STORE_SLOT';

export const DEVICE_PRESET_RECEIVED = 'DEVICE_PRESET_RECEIVED';
export const DEVICE_PROGRAM_CHANGE = 'DEVICE_PROGRAM_CHANGE';
export const DEVICE_UUID_RECEIVED = 'DEVICE_UUID_RECEIVED';
export const CLEAR_PRESET_LIST = 'CLEAR_PRESET_LIST';

export const DEVICE_RESOURCE_RECEIVED = 'DEVICE_RESOURCE_RECEIVED';
...
export const OWL_PROGRAM_ERROR_RECEIVED = 'OWL_PROGRAM_ERROR_RECEIVED';

export const SELECT_MIDI_INPUT_PORT_SUCCESS = 'SELECT_MIDI_INPUT_PORT_SUCCESS';
export const SELECT_MIDI_OUTPUT_PORT_SUCCESS = 'SELECT_MIDI_OUTPUT_PORT_SUCCESS';
...
export const UPDATE_COMPILATION_TYPE = 'UPDATE_COMPILATION_TYPE';
...
export const PATCH_SEO_NAME_CHANGED = 'PATCH_SEO_NAME_CHANGED';
